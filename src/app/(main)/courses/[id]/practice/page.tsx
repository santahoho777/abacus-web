...
export default function PracticePage({ params }: { params: { id: string } }) {
  ...
  }, [currentQ, inputValue, isSubmitting, currentIndex, lessonId, questions.length])
      ...
      <div className="max-w-lg mx-auto px-6 py-16 text-center">
        ...
        <div className="flex flex-col gap-3 max-w-xs mx-auto">
          <Link
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-6 rounded-xl cursor-pointer transition-colors text-center"
          >
            回到課程
          </Link>
          <Link
            href="/garden"
            className="bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-medium py-3 px-6 rounded-xl cursor-pointer transition-colors flex items-center justify-center gap-2"
          >
